...
<section class="certificate-wrapper bg-slate-100 py-10 min-h-screen">
    <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="certificate-actions mb-6 flex flex-wrap items-center justify-between gap-3">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Certificate No: <?php echo e($certificate->certificate_number); ?>
            ...
            <div class="certificate-header relative overflow-hidden text-center text-white">
                ...
                <div class="relative z-10 pt-7">
                    <div class="w-14 h-14 rounded-full bg-white mx-auto p-2 flex items-center justify-center">
                        <img src="<?php echo e($logo); ?>" alt="Uzima Milele" class="w-full h-full object-contain">
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Downloads\UzimaMilelefiles\UzimaSite\uzima-website\resources\views\certificates\show.blade.php ENDPATH**/ ?>