    ...
    <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <main class="lg:col-span-2 space-y-8 min-w-0">
            ...
            <div id="course-content" class="relative z-0 bg-white rounded-2xl shadow-sm p-6 md:p-8 scroll-mt-32">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lesson->finalQuiz): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/uzimamil/public_html/new.uzimamilele.or.tz/new/resources/views/lessons/show.blade.php ENDPATH**/ ?>