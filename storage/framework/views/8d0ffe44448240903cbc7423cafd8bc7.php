...
<section class="bg-gray-50 py-10">
    <div class="max-w-7xl mx-auto px-4 grid lg:grid-cols-3 gap-8">
        ...
        <aside class="bg-white rounded-2xl shadow-sm p-6 h-fit sticky top-24">
                            ...
                            <a href="<?php echo e(route('lessons.learn', ['lesson' => $lesson->slug, 'topic' => $topic->id])); ?>"
                               class="flex items-center justify-between gap-3 rounded-xl border px-4 py-3 text-sm transition
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isCompletedTopic): ?>
                                    <span class="text-xs font-black <?php echo e($isActiveTopic ? 'text-white' : 'text-green-600'); ?>">
                                        Imekamilika
                                    </span>
        ...
        <main class="font-lato lg:col-span-2 bg-white rounded-2xl shadow-sm p-6 md:p-10">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentTopic): ?>
                ...
                <div class="mb-6">
                    ...
                    <h2 class="text-3xl md:text-4xl font-black text-navy mt-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Downloads\UzimaMilelefiles\UzimaSite\uzima-website\resources\views\lessons\learn.blade.php ENDPATH**/ ?>