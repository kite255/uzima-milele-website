...
<form action="https://uzimamilele.us21.list-manage.com/subscribe/post?u=9484280256702e240d8f3f769&id=01a193b153&f_id=007760e1f0"
    ...
    <div class="max-w-7xl mx-auto px-4 py-12 grid md:grid-cols-4 gap-8">
        ...
        <div>
            ...
            <ul class="space-y-2 text-sm text-white/75">
                <li>
                    <a href="<?php echo e(route('home')); ?>" class="hover:text-white">
                        Nyumbani
                    </a>
                </li>

                <li>
                    <a href="<?php echo e(route('about')); ?>" class="hover:text-white">
                        Kuhusu sisi
                    </a>
                </li>

                <li>
                    <a href="<?php echo e(route('devotions.index')); ?>" class="hover:text-white">
                        Tafakari
                    </a>
                </li>

                <li>
                    <a href="<?php echo e(route('lessons.index')); ?>" class="hover:text-white">
                        Masomo
                    </a>
                </li>

                <li>
                    <a href="<?php echo e(route('children.index')); ?>" class="hover:text-white">
                        Watoto
                    </a>
                </li>
            </ul>
        ...
        <div>
            ...
            <ul class="space-y-2 text-sm text-white/75">
                <li>
                    <a href="<?php echo e(route('prayers.testimonies')); ?>" class="hover:text-white">
                        Maombi & Ushuhuda
                    </a>
                </li>

                <li>
                    <a href="<?php echo e(route('contact')); ?>" class="hover:text-white">
                        Mawasiliano
                    </a>
                </li>

                <li>
                   <a href="<?php echo e(route('changia')); ?>" class="hover:text-white">
    Changia
</a>
                </li>
            </ul>
    ...
    <div class="border-t border-white/10 py-4 text-center text-sm text-white/50">
        © <?php echo e(date('Y')); ?> Uzima Milele. All rights reserved.
        <span class="mx-2">•</span>
        Version 2.0.0
    </div>

</footer><?php /**PATH C:\Users\User\Downloads\UzimaMilelefiles\UzimaSite\uzima-website\resources\views\partials\footer.blade.php ENDPATH**/ ?>