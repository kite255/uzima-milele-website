        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="p-6 border-b flex items-center justify-between">
                ...
                <span class="text-sm bg-primary/10 text-primary font-bold px-4 py-2 rounded-full">
                    <?php echo e(auth()->user()->unreadNotifications()->count()); ?> mpya
                </span>
            </div>
            ...
            <div class="divide-y">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <a href="<?php echo e(route('notifications.read', $notification->id)); ?>"
                       class="block p-6 transition <?php echo e($isUnread ? 'bg-primary/5 hover:bg-primary/10' : 'hover:bg-gray-50'); ?>">
                        <div class="flex gap-4">
                            <div class="shrink-0">
                                <div class="w-12 h-12 rounded-2xl flex items-center justify-center <?php echo e($isUnread ? 'bg-primary text-white' : 'bg-gray-100 text-navy'); ?>">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-2 text-gray-600 leading-relaxed">
                                    <?php echo e($data['message'] ?? 'Una taarifa mpya.'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/uzimamil/public_html/new.uzimamilele.or.tz/new/resources/views/notifications/index.blade.php ENDPATH**/ ?>